...
public class ServerManager : MonoBehaviourPunCallbacks
{
  ...
  /*  void CarChosen() 
    ...
    public override void OnConnectedToMaster() //n�r man har connectat s� skickas man till ett rum. Efter man kommit in i ett rum s�tts v�nt-lobbyn p�, d�r man kan se spelarlistan och tiden till start
    {
